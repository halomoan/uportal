                                                        ...
                                                        <tbody>
                                                            ...
                                                            >
                                                                ...
                                                                <td>
                                                                    ...
                                                                    >
                                                                        <i
                                                                            class="far fa-file-pdf text-red"
                                                                        ></i>
                                                                    </router-link>
                                                                </td>
                                                            </tr>
    ...
    methods: {
        ...
        getTableData(page) {
            if (this.$Role.isAdminOrUser()) {
                ...
                axios
                    .all([axios.get("/api/invoices?n=true"), axios.get(uri)])
                    .then(
                        axios.spread((hasNew, data) => {
                            ...
                            this.pgTable[this.tabIndex].invoices =
                                invoiceData.data;
                            this.pgTable[this.tabIndex].records =
                                invoiceData.total;
                            this.pgTable[this.tabIndex].page =
                                invoiceData.current_page;
                            this.pgTable[this.tabIndex].perpage =
                                invoiceData.per_page;
                        })
                    );
            }
        },
