                    ...
                    <tbody>
                      <tr v-for="user in users" :key="user.id">
                        ...
                        <td>
                          ...
                          <a
                            href
                            class="fas fa-trash-restore-alt text-success"
                            tooltip="restore user"
                            @click.prevent="restoreUser(user.id, user.name)"
                          ></a>
                          /
                          <a
                            href
...
export default {
  data() {
    return {
      ...
      users: {},
      pgUsers: {
        uri: "api/user?qtype=person&qarch=true",
        page: 1,
        perpage: 10,
        records: 0,
        options: {
